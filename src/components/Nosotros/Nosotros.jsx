          ...
          <div className="telephone_container">
            ...
            <div className="telephone_text">
              <p>
                ...
                encontramos en el mercado. Abastecemos y abarcamos la logística
                de distribución de más de 50 localidades de la provincia de
                Buenos Aires.
                <br />
                Simplemente todo lo que necesitas para amueblar y decorar tu
                hogar a un solo Click. Hoy mediante nuestra tienda on-line podes
                ver nuestro amplio catálogo de productos. Ademas de brindarte la
                atención personalizada de nuestros asesores, que te guiaran
                durante todo el proceso y orientaran de manera profesional para
                hacer de cada espacio de tu hogar un lugar único. Encontrá en
                nosotros una nueva experiencia de compra y una nueva forma de
                mejorar tu hogar.
              </p>
            </div>
          </div>
